...
## TALİMATLAR
- Yukarıdaki gerçek verilerden yola çıkarak kapsamlı, içgörülü ve özgün bir analiz yap.
- Sayısal hesaplamalar yap (yüzdeler, oranlar, karşılaştırmalar).
- Bulguların pratik anlamını açıkla (örn. "Bu demek oluyor ki...").
- Eğer soru verinin dışına çıkıyorsa, bildiklerinden yola çıkarak makul bir tahmin yap ve bunu belirt.
- Türkçe yanıt ver.
- Markdown formatla (başlıklar, bullet listeler, kalın metin).
- Yanıtın sonuna 1-2 "İleri Analiz Önerisi" ekle (kullanıcının sorabileceklerinden ilham alan, konuyla ilgili).
PROMPT;
    }
}
