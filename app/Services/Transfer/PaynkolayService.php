...
{
    /**
     * @return array{redirect_url:string,provider_transaction_id:?string,response:array<string,mixed>}
     */
    public function initializePayment(
        TransferBooking $booking,
        TransferPaymentTransaction $transaction,
        string $successUrl,
        string $failUrl,
        ...
        if ($sx === '' || $merchantSecretKey === '' || $baseUrl === '') {
            ...
            return [
                'redirect_url' => route('transfer.payment.simulate', [
        ...
        $payload = [
            'sx' => $sx,
            'clientRefCode' => $transaction->reference,
            'amount' => $amount,
