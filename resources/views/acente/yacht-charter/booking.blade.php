...
<div class="container">
    ...
    <div class="d-flex align-items-center gap-2 mt-3 mb-1" style="font-size:.82rem;color:var(--muted);">
        <a href="{{ route('acente.yacht-charter.catalog') }}" style="color:var(--muted);text-decoration:none;">Yat Charter</a>
    ...
    <div class="bk-layout">
        ...
        <div>
            ...
            <div class="bk-card">
                ...
                @endif
                @if($detail?->marina_name)
                    <div class="bk-row"><span class="bk-row-label">Marina</span><span class="bk-row-val">{{ $detail->marina_name }}</span></div>
                @endif
                ...
                @if($detail?->route_plan)
                    <div class="bk-row"><span class="bk-row-label">Güzergah</span><span class="bk-row-val">{{ $detail->route_plan }}</span></div>
                @endif
            </div>
        ...
        <div>
            <div class="bk-card" style="position:sticky;top:72px;">
                ...
                <a href="{{ route('acente.yacht-charter.catalog') }}" class="d-flex align-items-center gap-2 text-decoration-none" style="font-size:.82rem;color:var(--muted);">
