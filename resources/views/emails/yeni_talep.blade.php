...
<div class="wrapper">
  <div class="header">
    ...
    <h2>Yeni Grup Uçuş Talebi</h2>
  </div>
  <div class="body">
    <div class="badge">🆕 Yeni Talep</div>
    <div class="gtpnr">{{ $gtpnr }}</div>
    <table class="info-table">
      <tr><td>Acente</td><td>{{ $agencyName }}</td></tr>
      <tr><td>Yolcu Sayısı</td><td><strong>{{ $paxTotal }} PAX</strong></td></tr>
      <tr><td>Oluşturulma</td><td>{{ now()->format('d.m.Y H:i') }}</td></tr>
    </table>
