...
<title>GrupTalepleri — Platforma Davet</title>
</head>
  ...
  <tr>
    <td style="padding:36px 40px;">
      ...
      <p style="font-size:15px;color:#495057;line-height:1.75;margin:0 0 28px;">
        ...
        uçtan uca takip etmek için tasarlanmış bu platformda <strong>ücretsiz hesap açarak</strong> hemen başlayabilirsiniz.
      </p>
      ...
      <div style="font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1.2px;color:#e8a020;margin-bottom:12px;">
        Süreci Baştan Sona Takip Edin
      </div>
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
        <tr>
          <td style="padding:8px 0;border-bottom:1px solid #f0f0f0;">
            <span style="font-size:16px;margin-right:10px;">📡</span>
            <span style="font-size:13px;color:#212529;"><strong>Anlık durum takibi</strong> — Beklemede, fiyatlandırıldı, onaylandı, biletlendi — her adım etiketli.</span>
          </td>
        </tr>
        <tr>
          <td style="padding:8px 0;border-bottom:1px solid #f0f0f0;">
            <span style="font-size:16px;margin-right:10px;">💰</span>
            <span style="font-size:13px;color:#212529;"><strong>Depozito & bakiye yönetimi</strong> — Yakın tarihlerde tam ödeme, ileri tarihlerde ayrı adımlarla izleme.</span>
          </td>
        </tr>
        <tr>
          <td style="padding:8px 0;border-bottom:1px solid #f0f0f0;">
            <span style="font-size:16px;margin-right:10px;">🔔</span>
            <span style="font-size:13px;color:#212529;"><strong>Çok kanallı bildirim</strong> — Teklif hazırlandığında e-posta, SMS ve platform içi bildirim aynı anda.</span>
          </td>
        </tr>
        <tr>
          <td style="padding:8px 0;">
            <span style="font-size:16px;margin-right:10px;">📄</span>
            <span style="font-size:13px;color:#212529;"><strong>PDF teklif çıktısı</strong> — Dinner Cruise ve Yacht tekliflerini müşterinize anında iletin.</span>
          </td>
        </tr>
      </table>
